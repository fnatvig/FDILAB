...
# language as the gui
# msg_df = pd.read_csv("proprietary_protocol.csv", delimiter=";")
# msg = msg_df.iloc[0, :]
msg = [0, 14, 9, 2, 3, 4]
...
def main():
    ...
    sock.bind((UDP_IP, POWER_PORT))
    sock.sendto(POWERENGINE_READY, (UDP_IP, GUI_PORT))


    running = wait_for_confirmation()
